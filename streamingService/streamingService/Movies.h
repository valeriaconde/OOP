...
public:
    ...
    void pelisConCalif() {
        ...
        // Printing
        cout << "# id    Titulo     duración     genero    calificación    oscares" << endl;
        cout << "-----------------------------------------------------------------" << endl;
        ...
        // Avg rating
        cout << "Promedio Peliculas :" << sum / movies.size() << endl;
    }
    ...
    void addOscar() {
        ...
        // Imprimir oscars
        cout << "Oscars de Pelicula 4: 10" << endl;
    }
